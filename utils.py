...
def save_checkpoint_active_learning(acquisition_function, acquisition_iter, model, optimizer, mAP, train_indices):
    state = {'acquisition_function': acquisition_function,
             'acquisition_iter': acquisition_iter,
             'model': model,      
             'optimizer': optimizer,
             'mAP': mAP,
             'train_indices': train_indices}
    filename = 'checkpoint_' + acquisition_function + '_' + str(acquisition_iter) + '.pth.tar'
    torch.save(state, filename)
